...
const coreTools = [
  { href: "/research", icon: "▤", tone: "mint", title: "말씀 연구", copy: "배경·문맥·원어와 견해를 확인합니다." },
  { href: "/workspace", icon: "✎", tone: "blue", title: "사역 작업", copy: "기도문·문서·설교 개요를 정리합니다." },
  { href: "/worship", icon: "♫", tone: "purple", title: "찬양 플래너", copy: "본문과 예배 흐름에 맞춰 선곡합니다." },
  { href: "/prayer", icon: "♢", tone: "orange", title: "기도문 작성", copy: "상황과 예배에 맞는 기도문을 준비합니다." },
  { href: "/image-content", icon: "▧", tone: "pink", title: "이미지 디자인", copy: "포스터와 콘텐츠 제작을 시작합니다." },
];
